...
public class PurchaseRecord extends UpdatableRecordImpl<PurchaseRecord> implements Record5<Long, DateTime, Long, BigDecimal, Long>, IPurchase {

	private static final long serialVersionUID = -383433490;
	 ...
	 */
	@Override
	public Row5<Long, DateTime, Long, BigDecimal, Long> fieldsRow() {
	 ...
	 */
	@Override
	public Row5<Long, DateTime, Long, BigDecimal, Long> valuesRow() {
	 ...
	 */
	@Override
	public PurchaseRecord value2(DateTime value) {
	 ...
	 */
	@Override
	public PurchaseRecord values(Long value1, DateTime value2, Long value3, BigDecimal value4, Long value5) {
		value1(value1);
		value2(value2);
		value3(value3);
		value4(value4);
	 ...
	 */
	public PurchaseRecord(Long id, DateTime creationdate, Long quantity, BigDecimal price, Long itemId) {
		super(Purchase.PURCHASE);
